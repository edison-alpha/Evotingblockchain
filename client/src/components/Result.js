        ...
        <div>
            ...
            {!account ? (
                <div className="flex flex-col items-center justify-center h-screen">
                    <p className="text-xl font-semibold text-gray-900">Wallet not connected</p>
                    <p className="mt-2 text-sm text-gray-700">Please connect your wallet to access this page.</p>
                </div>
            ) : (
                <div>
