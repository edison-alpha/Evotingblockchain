...
const Result = () => {
  ...
  const ClickToFindWinner = async () => {
    ...
    try {
      ...
      console.log("Data pemenang:", getWinnerData); // Log data pemenang
      ...
      // {{ edit_1 }}: Menambahkan alert setelah berhasil menghitung suara
      toast.success("Suara berhasil dihitung!", {
        position: "top-right", // Menggunakan posisi dari VoteArea.js
        autoClose: 10000,
      ...
      console.log(error);
      // {{ edit_2 }}: Menambahkan alert jika terjadi kesalahan
